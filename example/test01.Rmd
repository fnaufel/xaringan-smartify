...
Some of the tests are failing, but I would need a parser --- and not just regexes --- to solve this.
...
* It's working, but in display math neither the opening `$$` nor the closing `$$` can be in lines by themselves. 
